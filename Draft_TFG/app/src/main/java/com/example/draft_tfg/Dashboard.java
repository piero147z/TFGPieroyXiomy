...
public class Dashboard extends AppCompatActivity implements View.OnClickListener{
    ...
    Button modificarConsulta, login ;
    int dataTest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     FormularioTable f = new FormularioTable(this);
    ...
    //KPI object
        ...
        amPrestamo = f.obtenerDineroNecesita1();
        ...
        plazoEnAnios = f.obtenerTiempoPrestamo1();
    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            case R.id.modificarC:
                Intent intent2 = new Intent(Dashboard.this, UpdateData.class);
